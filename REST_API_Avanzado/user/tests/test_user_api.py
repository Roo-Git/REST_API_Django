...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """ Test de crear un Usuario que ya existe """
        payload = {
          'email': 'test@datadosis.com',
          'password': 'testopass',
          'name': 'Test name',
    ...
    def test_create_token_no_user(self):
        """ Prueba que no sea un token sino existe el usuario """
        payload = {'email': 'test@datadosis.com', 'password': 'testopass'} 
        res = self.client.post(TOKEN_URL, payload) 
    ...
    def test_create_token_missing_field(self):
        """ Probar que el email y la contraseña son requeridos """
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        """ Probar que el usuario esta siendo actualizado si esta autentificado """
